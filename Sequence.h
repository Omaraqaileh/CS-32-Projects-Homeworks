...
public:
    ...
    int size() const;    // Return the ItemType of items in the sequence.
    ...
    // ItemType of items removed (which will be 0 if no item == value).

    const bool get(int pos, ItemType& value) const;
